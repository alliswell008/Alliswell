 ...
 * @date 2016/11/24 21:21
 */
public class AbstractReflectFactoryCalculatorSPI {
     ...
     * @throws
     */
    public static void client_AbstractReflectFactoryCalculatorSPI() {
        ...
        ServiceLoader<OperationAbstractFactory> loaders = ServiceLoader.load(OperationAbstractFactory.class);
        OperationAbstractFactory next = loaders.iterator().next();
        op = (next).createInstance(map.get(operation));
