package alliswell.pattern.structural.adapter;

import alliswell.pattern.structural.adapter.classadapter.Adapter;
import alliswell.pattern.structural.adapter.classadapter.Adapter2;
import alliswell.pattern.structural.adapter.interfaceadapter.IAdapterSub1;
import alliswell.pattern.structural.adapter.interfaceadapter.IAdapterSub2;
import alliswell.pattern.structural.adapter.objectadapter.Wrapper;
import alliswell.pattern.structural.adapter.objectadapter.Wrapper2;
import alliswell.pattern.structural.adapter.original.Adaptee;
