package org.alliswell.demo.codeblock;
...
public class CodeBlockDemo {
	...
	static void loadCodeClass() throws ClassNotFoundException {
		...
		Class c1 = Class.forName("org.alliswell.demo.codeblock.Code", false, CodeBlockDemo.class.getClassLoader());
		System.out.println("==类装载，并初始化，执行了静态代码块==");
		//装载类，并进行初始化，静态代码块执行
		Class c2 = Class.forName("org.alliswell.demo.codeblock.Code", true, CodeBlockDemo.class.getClassLoader());
